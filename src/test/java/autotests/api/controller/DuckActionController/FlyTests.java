...
public class FlyTests extends DuckActionsClient {
    ...
    @Test(description = "ѕроверка fly с существующим id с активными крыль€ми")
    @CitrusTest
    ...
    @Test(description = "ѕроверка fly с существующим id со св€занными крыль€ми")
    @CitrusTest
    ...
    @Test(description = "ѕроверка fly с существующим id с крыль€ми в неопределенном состо€нии")
    @CitrusTest
